      ...
      <div className="absolute inset-0 w-full h-full">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 z-10 gap-8">
          <div className="w-full max-w-4xl opacity-0 animate-[fadeIn_2.5s_ease-in-out_forwards] flex flex-col items-center gap-6">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-white tracking-wide uppercase text-center drop-shadow-sm">
              The Latif Foundation
            </h1>
            <div className="h-px w-24 bg-white/60" />
            <p className="text-lg md:text-2xl text-white/90 font-light tracking-wider text-center max-w-2xl drop-shadow-sm leading-relaxed">
              Honoring a life. Building a legacy. <br className="hidden sm:block" />
              Empowering communities in West Africa.
            </p>
          </div>
          <div className={`transition-all duration-200 ease-out fill-mode-forwards opacity-100 translate-y-0 scale-100 mt-8`}>
            <Button
              asChild
